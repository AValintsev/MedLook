...
{
    public class WidgetsNovaPoshtaViewComponent : NopViewComponent
    {
        private readonly NovaPoshtaSettings _novaPoshtaSettings;

        public WidgetsNovaPoshtaViewComponent(NovaPoshtaSettings novaPoshtaSettings)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync(string widgetZone, object additionalData)
        {
            ...
            return View("~/Plugins/Shipping.NovaPoshta/Views/PublicInfo.cshtml", model);
        }
    }
}
